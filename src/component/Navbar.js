  ...
  return (
    <nav className="relative w-full z-50 bg-gradient-to-r from-blue-600 via-indigo-700 to-emerald-600 shadow-lg backdrop-blur-lg bg-opacity-80 px-10 py-4 flex justify-between items-center">
      ...
      <div className="logo hover:scale-110 transition-transform duration-300 ">
        <Link
          href="/"
          className="text-3xl md:text-4xl font-mono font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-emerald-300 tracking-tight    "
        >
          &lt; ArdSuhail /&gt;
        </Link>
      </div>
      ...
      {/* Navigation Links */}
      <ul className="flex gap-6 md:gap-10 items-center text-lg font-medium text-gray-200">
        {[
          ["Home", "/"],
          ["About", "/about"],
          ["Skills", "/skills"],
